...
namespace ImagingDemo.Barcode
{
    ...
    public class BarcodeWriterTool : RectangularSelectionTool
    {
        ...
        public BarcodeWriterTool()
        {
            ...
            _refreshBarcodeButton.Image = ImagingDemoResources.GetResourceAsImage("RefreshBarcodeImage.png");
            // create the "Draw barcode" button
            _drawBarcodeButton = new InteractionButton(this);
            _drawBarcodeButton.Image = ImagingDemoResources.GetResourceAsImage("DrawBarcodeImage.png");
