...
namespace ImagingDemo
{
    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            viewerToolStrip.AddVisualTool(new BarcodeReaderToolInfo(barcodeReaderToolButton));
            viewerToolStrip.AddVisualTool(new BarcodeWriterToolInfo(barcodeWriterToolButton));
        ...
        private void UpdateUI()
        {
            ...
            PdfDemosTools.EnableAuthenticateRequest = true;
            // set CustomFontProgramsController for all opened PDF documents
            PdfDemosTools.UseCustomFontProgramsController = true;
#endif
        ...
        private void saveChangesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (EncoderFactory.GetEncoder(_sourceDecoderName, false, false, false, out encoder))
        ...
        private void saveAsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    EncoderBase encoder = null;
                    if (EncoderFactory.GetEncoder(filename, true, false, true, out encoder))
        ...
        private void saveToToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                {
                    EncoderBase encoder = null;
                    if (EncoderFactory.GetEncoder(filename, true, isFileExist, true, out encoder))
        ...
        {
            using (MetadataEditorForm dialog = new MetadataEditorForm())
            {
                dialog.Image = imageViewer1.Image;
                dialog.ShowDialog();
                UpdateUI();
            }
        }
        ...
        {
            ImageViewerMapSettingsForm mapSettingsDialog = new ImageViewerMapSettingsForm(_imageMapTool);
        ...
        {
            using (MagnifierToolSettingsForm dialog = new MagnifierToolSettingsForm())
            {
                dialog.Magnifier = viewerToolStrip.MagnifierTool;
                dialog.ShowDialog();
            }
        }
        ...
        private void resizeCanvasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            using (ResizeCanvasForm dlg = new ResizeCanvasForm(image.Width, image.Height))
            {
                if (dlg.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ResizeCanvasCommand command = new ResizeCanvasCommand(dlg.CanvasWidth, dlg.CanvasHeight, dlg.ImagePosition, dlg.CanvasColor);
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(command);
                }
            }
        }
        ...
        {
            using (FillImageForm dlg = new FillImageForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        private void histogramToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                using (GetHistogramForm dlg = new GetHistogramForm(imageViewer1.Image))
                    dlg.ShowDialog();
            }
            catch (Exception ex)
            {
        ...
        private void convertToBlackWhiteThresholdByUserToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (imageViewer1.Image.PixelFormat != PixelFormat.BlackWhite)
            {
                using (BinarizeForm dlg = new BinarizeForm(imageViewer1, false))
                {
                    if (dlg.ShowProcessingDialog())
                        _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
                }
        ...
        private void convertToBlackWhiteAdaptiveThresholdToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (imageViewer1.Image.PixelFormat != PixelFormat.BlackWhite)
            {
                using (AdaptiveBinarizeForm dlg = new AdaptiveBinarizeForm(imageViewer1, false))
                {
                    if (dlg.ShowProcessingDialog())
                        _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
                }
        ...
        private void posterizeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (imageViewer1.Image.PixelFormat != PixelFormat.BlackWhite)
            {
                using (PosterizeForm dlg = new PosterizeForm(imageViewer1))
                {
                    if (dlg.ShowProcessingDialog())
                        _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
                }
        ...
        {
            using (BrightnessContrastForm dlg = new BrightnessContrastForm(imageViewer1, imageViewer1.Image))
            {
        ...
        {
            using (HueSaturationLuminanceForm dlg = new HueSaturationLuminanceForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (GammaForm dlg = new GammaForm(imageViewer1))
            {
                dlg.UseCurrentViewerZoomWhenPreviewProcessing = true;
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
        ...
        {
            using (LevelsForm dlg = new LevelsForm(imageViewer1))
            {
                dlg.UseCurrentViewerZoomWhenPreviewProcessing = true;
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
        ...
        {
            using (ReplaceColorForm dlg = new ReplaceColorForm(imageViewer1))
            {
                dlg.UseCurrentViewerZoomWhenPreviewProcessing = true;
                if (dlg.ShowProcessingDialog())
                {
        ...
        {
            using (ColorTransformForm dlg = new ColorTransformForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                {
        ...
        private void Rotate_Click(object sender, EventArgs e)
        {
            if (sender == customToolStripMenuItem || sender == customToolStripMenuItem1)
            {
                using (RotateForm dlg = new RotateForm(imageViewer1.Image.PixelFormat))
                {
                    if (dlg.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                    {
                        ...
                        _imageProcessingCommandExecutor.ExecuteProcessingCommand(new RotateCommand((float)dlg.Angle, dlg.BorderColorType));
                    }
                }
            }
            else
            {
                ...
                _imageProcessingCommandExecutor.ExecuteProcessingCommand(new RotateCommand(angle, Color.Black));
            }
        }
        ...
        {
            using (ImageScalingForm dlg = new ImageScalingForm())
            {
        ...
        {
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new SkewCommand()))
            {
        ...
        {
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new QuadrilateralWarpCommand()))
            {
                dlg.IsPreviewAvailable = false;
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
        ...
        {
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new MatrixTransformCommand()))
            {
                dlg.IsPreviewAvailable = false;
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
        ...
        {
            using (MinimumForm dlg = new MinimumForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (MaximumForm dlg = new MaximumForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (MidpointForm dlg = new MidpointForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (MeanForm dlg = new MeanForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (MedianForm dlg = new MedianForm(imageViewer1))
            {
                dlg.IsPreviewEnabled = false;
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
        ...
        {
            using (DilateForm dlg = new DilateForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
        ...
        {
            using (ErodeForm dlg = new ErodeForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
        ...
        {
            using (BlurForm dlg = new BlurForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (GaussianBlurForm dlg = new GaussianBlurForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (SharpenForm dlg = new SharpenForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (EmbossForm dlg = new EmbossForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new AddNoiseCommand()))
            {
                dlg.IsPreviewAvailable = false;
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
        ...
        {
            using (CannyEdgeDetectorForm dlg = new CannyEdgeDetectorForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        /// <summary>
        /// Determines that image is inverted.
        /// </summary>
        private void isDocumentImageInvertedToolStripMenuItem_Click(object sender, EventArgs e)
        {
            _imageProcessingCommandExecutor.ExecuteIsInvertedCommand();
        }
        ...
        {
#if !REMOVE_DOCCLEANUP_PLUGIN
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new DespeckleCommand()))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        private void deskewDocumentImageToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new DeskewDocumentImageCommand()))
            {
                dlg.IsPreviewAvailable = false;
                dlg.UseCurrentViewerZoomWhenPreviewProcessing = true;
                if (dlg.ShowProcessingDialog())
        ...
        private void deskewToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new DeskewCommand()))
            {
                dlg.IsPreviewAvailable = false;
                dlg.UseCurrentViewerZoomWhenPreviewProcessing = true;
                if (dlg.ShowProcessingDialog())
        ...
        {
#if !REMOVE_DOCCLEANUP_PLUGIN
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new AutoTextOrientationCommand()))
            {
                dlg.IsPreviewAvailable = false;
                dlg.UseCurrentViewerZoomWhenPreviewProcessing = true;
                if (dlg.ShowProcessingDialog())
        ...
        {
#if !REMOVE_DOCCLEANUP_PLUGIN
            using (AutoTextInvertForm dlg = new AutoTextInvertForm(imageViewer1))
            {
                dlg.IsPreviewEnabled = false;
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
        ...
        {
            using (BorderRemovalForm dlg = new BorderRemovalForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
#if !REMOVE_DOCCLEANUP_PLUGIN
            using (HalftoneRemovalForm dlg = new HalftoneRemovalForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
#if !REMOVE_DOCCLEANUP_PLUGIN
            using (SmoothingForm dlg = new SmoothingForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        private void holePunchRemovalToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, holePunchRemovalCommand))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
#if !REMOVE_DOCCLEANUP_PLUGIN
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new LineRemovalCommand()))
            {
                dlg.IsPreviewEnabled = false;
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
        ...
        {
#if !REMOVE_DOCCLEANUP_PLUGIN
            using (ColorNoiseClearForm dlg = new ColorNoiseClearForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (BevelEdgeForm dlg = new BevelEdgeForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new DropShadowCommand()))
            {
                dlg.IsPreviewAvailable = false;
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
        ...
        {
            using (MotionBlurForm dlg = new MotionBlurForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (MosaicForm dlg = new MosaicForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (OilPaintingForm dlg = new OilPaintingForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (PixelateForm dlg = new PixelateForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (RedEyeRemovalForm dlg = new RedEyeRemovalForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (TileReflectionForm dlg = new TileReflectionForm(imageViewer1))
            {
                dlg.IsPreviewEnabled = false;
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
        ...
        {
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new IdealLowpassCommand()))
            {
        ...
        {
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new ButterworthLowpassCommand()))
            {
                dlg.IsPreviewAvailable = true;
                dlg.IsPreviewEnabled = false;
                dlg.UseCurrentViewerZoomWhenPreviewProcessing = true;
        ...
        {
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new GaussianLowpassCommand()))
            {
                dlg.IsPreviewAvailable = true;
                dlg.IsPreviewEnabled = false;
                dlg.UseCurrentViewerZoomWhenPreviewProcessing = true;
        ...
        {
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new IdealHighpassCommand()))
            {
                dlg.IsPreviewAvailable = true;
                dlg.IsPreviewEnabled = false;
                dlg.UseCurrentViewerZoomWhenPreviewProcessing = true;
        ...
        {
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new ButterworthHighpassCommand()))
            {
                dlg.IsPreviewAvailable = true;
                dlg.IsPreviewEnabled = false;
                dlg.UseCurrentViewerZoomWhenPreviewProcessing = true;
        ...
        {
            using (PropertyGridConfigForm dlg = new PropertyGridConfigForm(imageViewer1, new GaussianHighpassCommand()))
            {
                dlg.IsPreviewAvailable = true;
                dlg.IsPreviewEnabled = false;
                dlg.UseCurrentViewerZoomWhenPreviewProcessing = true;
        ...
        {
            using (ImageSmoothingForm dlg = new ImageSmoothingForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (ImageSharpeningForm dlg = new ImageSharpeningForm(imageViewer1))
            {
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
            }
        ...
        {
            using (FrequencySpectrumVisualizerForm dlg = new FrequencySpectrumVisualizerForm(imageViewer1))
            {
                dlg.IsPreviewEnabled = false;
                if (dlg.ShowProcessingDialog())
                    _imageProcessingCommandExecutor.ExecuteProcessingCommand(dlg.GetProcessingCommand());
        ...
        /// <summary>
        /// Enables/disables multithreading for image processing.
        /// </summary>
        ...
        private void UpdateImageInfo()
        {
            try
            {
                ...
                imageInfoLabel.Text = string.Format("{0}{1}{2} Codec={8}; Size={3}x{4} ({5}); PixelFormat={6}; Resolution={7}",
                    ...
                    sizeInfo,
                    image.PixelFormat, image.Resolution, DemosTools.GetImageCompression(image));
            }
            catch
            {
            }
